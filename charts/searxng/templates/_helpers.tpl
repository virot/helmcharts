...
{{- printf "%s-redis" (include "searxng.fullname" .) }}
{{- end }}

{{/*
Redis URL
*/}}
{{- define "searxng.redis.url" -}}
{{- if .Values.redis.enabled }}
{{- printf "redis://%s:%d/0" (include "searxng.redis.fullname" .) (int .Values.redis.service.port) }}
{{- else }}
{{- .Values.env.SEARXNG_REDIS_URL }}
{{- end }}
{{- end }}
